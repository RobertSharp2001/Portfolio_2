...
public class ChaserFSM : FiniteStateMachine{
    [HideInInspector]
    public ChaserIdle idleState;
    [HideInInspector]
    public ChaserActive movingState;
    [HideInInspector]
    ...
    private void Awake() {
        idleState = new ChaserIdle(this);
        movingState = new ChaserActive(this);
